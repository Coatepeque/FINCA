...
import controladores.PlanillaJpaController;
...
public class PlanillaController implements Serializable {
    ...
    private PlanillaJpaController jpaController = null;
    ...
    private PlanillaJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new PlanillaJpaController(Persistence.createEntityManagerFactory("FincaPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getPlanillaCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findPlanillaEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getIdPlanilla());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getPlanillaCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findPlanillaEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findPlanillaEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findPlanillaEntities(), true);
    }
    ...
    public static class PlanillaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findPlanilla(getKey(value));
        }
