...
import controladores.FincaJpaController;
...
public class FincaController implements Serializable {
    ...
    private FincaJpaController jpaController = null;
    ...
    private FincaJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new FincaJpaController(Persistence.createEntityManagerFactory("FincaPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getFincaCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findFincaEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getIdFinca());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getFincaCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findFincaEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findFincaEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findFincaEntities(), true);
    }
    ...
    public static class FincaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Finca) {
                ...
                return getStringKey(o.getIdFinca());
            } else {
