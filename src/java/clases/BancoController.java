...
public class BancoController implements Serializable {
    ...
    private BancoJpaController jpaController = null;
    ...
    private BancoJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new BancoJpaController(Persistence.createEntityManagerFactory("FINCAPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getBancoCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findBancoEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getIdBanco());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getBancoCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findBancoEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findBancoEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findBancoEntities(), true);
    }
    ...
    public static class BancoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findBanco(getKey(value));
        }
