...
public class EmpleadoController implements Serializable {
    ...
    private EmpleadoJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new EmpleadoJpaController(Persistence.createEntityManagerFactory("FincaCorpPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getEmpleadoCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findEmpleadoEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getIdEmpleado());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getEmpleadoCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findEmpleadoEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findEmpleadoEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findEmpleadoEntities(), true);
    }
    ...
    public static class EmpleadoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findEmpleado(getKey(value));
        }
